...
require('lazy').setup {
  ...
  { 'nvim-treesitter/nvim-treesitter',
    ...
    init = function()
      local langs = { 'bash', 'c', 'cpp', 'css', 'git_config', 'go', 'gomod', 'gosum', 'gotmpl',
        'gowork', 'hcl', 'html', 'javascript', 'jinja', 'just', 'make', 'markdown', 'perl',
        'python', 'rust', 'sql' }
      ...
      for _, lang in ipairs(langs) do
        vim.api.nvim_create_autocmd('FileType', {
          ...
          callback = function(ev)
            ...
            if not vim.tbl_contains(langs_no_indent, ev.match) then
